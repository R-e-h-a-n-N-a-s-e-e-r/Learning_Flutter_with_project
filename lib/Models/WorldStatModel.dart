...
class WorldStatModel {
  ...
  WorldStatModel.fromJson(dynamic json) {
...
WorldStatModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldStatModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
